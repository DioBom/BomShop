...
/***/ function(module, exports, __webpack_require__) {
	...
	//import menuEditor from './reducers/index';

	//let store = createStore(menuEditor);
	//
	    ...
	    _createClass(Item, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'li',
	                { draggable: 'true', className: 'list-group-item list-group-item-success' },
	                this.props.name
	            );
	        }
	    }]);
	...
	var App = function (_Component2) {
	    ...
	    _createClass(App, [{
	        key: 'render',
	        value: function render() {
	            var lists = [{ name: 'a' }, { name: 'b' }, { name: 'c' }, { name: 'd' }];

	            return _react2.default.createElement(
	                'ul',
	                { className: 'list-group' },
	                lists.map(function (list, index) {
	                    return _react2.default.createElement(Item, { key: index, name: list.name });
	                })
	            );
	        }
	    }]);
	...
	_reactDom2.default.render(_react2.default.createElement(App, null), document.getElementById('test'));
