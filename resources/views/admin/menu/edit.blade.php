    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('admin::menu.update', $menu->id) }}" role="form" class="form-horizontal" method="post">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            <label for="menuTitle" class="col-sm-2 control-label">标题：</label>
                            <div class="col-sm-10">
                                <input name="title" type="text" class="form-control" id="menuTitle" value="{{ $menu->title }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input name="icon" type="text" class="form-control" id="menuIcon" value="{{ $menu->icon  }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="url" type="text" class="form-control" id="menuURL" value="{{ $menu->url }}">
                        ...
                        <div class="form-group　{{ $errors->has('sort') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input name="sort" type="text" class="form-control" id="menuSort" value="{{ $menu->sort }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label class="radio-inline">
                                    <input type="radio" name="status" id="menuStatus" value="1" {{ $menu->status ? 'checked' : '' }}> 启用
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="status" value="0" {{ $menu->status ? '' : 'checked' }}> 禁用
                                </label>
                            </div>
                        </div>
                    </div>
