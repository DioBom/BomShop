...
namespace {
    ...
    class Admin extends \App\Support\Facades\Admin{
        ...
        public static function asset($path){
            return \App\Services\Admin\Admin::asset($path);
        }
         ...
         * @static 
         */
        public static function pluginAsset($path){
            return \App\Services\Admin\Admin::pluginAsset($path);
        }
         ...
         * @static 
         */
        public static function staticAsset($path){
            return \App\Services\Admin\Admin::staticAsset($path);
        }
